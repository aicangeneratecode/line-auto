    ...
    <section className="relative min-h-[75dvh] sm:min-h-[100dvh] flex items-center overflow-hidden bg-secondary hidden md:block">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-2 sm:pt-8 sm:pb-6 md:pt-20 md:pb-8">
        <div className="max-w-2xl max-w-full">
          <p className="hidden sm:inline-block bg-accent/20 text-accent px-4 py-1 rounded-full text-sm font-semibold backdrop-blur-sm border border-accent/30 mb-4 animate-fade-in-up">
            {t('badge')}
          </p>
          ...
          <p className="mt-4 text-base sm:text-lg text-gray-200 leading-relaxed max-w-lg animate-fade-in-up animation-delay-200">
            {t('description')}
          </p>

          <div className="mt-8 flex flex-wrap gap-3 sm:gap-4 animate-fade-in-up animation-delay-300">
            <Link
              href={`/${locale}#contact`}
